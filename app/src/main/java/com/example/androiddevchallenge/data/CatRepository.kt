...
sealed class CatList {
    data class SixCats(val cats: List<Cat>) : CatList()
    data class FiveCats(val cats: List<Cat>) : CatList()
    data class ThreeCats(val cats: List<Cat>) : CatList()
}
